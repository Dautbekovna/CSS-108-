...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        circle.setOnMouseClicked(e -> {
            s = e.getX() + " " + e.getY();
            textArea.appendText("Mouse event handler has been called for circle. Location=(" + s + ")\n");
        });
        ...
        ellipse.setOnMouseClicked(e -> {
            fadeTransition.play();
            s = e.getX() + " " + e.getY();
            textArea.appendText("Mouse event handler has been called for ellipse. Location=(" + s + ")\n");
        });

        Scene scene = new Scene(vbox, 600, 400);
        primaryStage.setTitle("Practice Activity #6C");
